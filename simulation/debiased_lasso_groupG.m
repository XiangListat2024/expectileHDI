%% This function is core-part for the node-wise procedure with Lasso method (Group test)
...
function [output] = debiased_lasso_groupG(Y,Z,coeff,tau,lambda_j,G,alpha)
...
% Use cvx to solve specific nodewise-lasso problem.
  for i = 1 : k_G
      ...
      coeff_nodewise(i,:) = nodewise_lasso(Q_1,Q_2,0.95*lambda_j);
...
output_debiased = n* debiased * inv(hat_Omega) * debiased' ;
