%% This function is core-part for the node-wise procedure with SCAD method 
% Author: Xiang Li
...
function [output] = debiased_lasso_spa_scad(Y,Z,coeff,tau,lambda_j,kk,alpha)
...
% Use cvx to solve specific nodewise-lasso problem.
  %for i = 1 : p
      ...
      coeff_nodewise = nodewise_lla_spa(Q_1,Q_2,lambda_j,3.7);
 ...
 judge_1 = ( 0< lower_bound ) + ( 0>upper_bound);
 ...
 output = [output_debiased,estimated_variance,student_test_stat,judege ,judge_1,ci_length];
end